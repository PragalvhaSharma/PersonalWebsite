...
export default function BlogsSection() {
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500 mb-8">Blog</h2>
      <div className="bg-gray-900/40 backdrop-blur-md p-12 rounded-2xl border border-gray-800/80 shadow-xl text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-400 mb-8">I&apos;m working on some exciting content to share my thoughts and experiences in technology, entrepreneurship, and software development. Stay tuned!</p>
