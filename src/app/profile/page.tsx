...
export default function ProfilePage() {
  ...
  const profile = {
    projects: [
      ...
      {
        title: "M3Drop-PY",
        description: "Using AI to convert the M3Drop package into a Python implementation; updated paper to be published in December 2025.",
        color: "#24292F",
          ...
          <div className="w-full md:w-1/3 flex justify-center mt-8 md:mt-0">
            <div className="relative w-48 h-48 sm:w-56 sm:h-56 opacity-0 animate-fade-in-delayed">
              <Image
                ...
                loading="eager"
                placeholder="blur"
                blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8Xw8AApMBgU3Y0rwAAAAASUVORK5CYII="
